...
//Забавное примечание! Благодаря папки ReadBean, которая была скачано сайта, например я создал БД, а она в свою очеред 
//все остальное(таблицу со всеми данными), в регистраций я вписал данные, они ушли в БД!
...
if(isset($data['register'])){
    ...
    // и по очериди проверять каждое поле для того чтобы в каждой форме писали необходимое,
    //а не ставили символы например в поле имени
...
<body>
    ...
    <form action="register.php" method="POST" enctype="multipart/form-data" >
        ...
        <!-- забавно в html я писал в конце require, как бы обязывая заполнить поле,
        команда сверху в 1 поле все обьединяет -->
